...
$ cd Catena-Sketches/catena4410_sensor1

$ # confirm that you're in the right place.
$ ls
assets/ catena4410_sensor1.ino  git-repos.dat  README.md  VERSION.txt
```
...
Next, open the boards manager. `Tools>Board:...`, and get up to the top of the menu that pops out -- it will give you a list of boards. Search for `MCCI` in the search box and select `MCCI Catena SAMD Boards`. An `[Install]` button will appear to the right; click it.
...
```console
$ cd Catena4410-Sketches/catena4410_sensor1
$ ../git-boot.sh
...
In the IDE, use File>Open to load the `catena4410_sensor1.ino` sketch. (Remember, in step 1 you cloned `Catena-Sketches` -- find that, and navigate to `{somewhere}/Catena-Sketches/catena4410_sensor1/`)
